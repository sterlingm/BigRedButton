...
public class TrumpActionList : MonoBehaviour
{
    // Singleton
    public static TrumpActionList self = null;
	...
	void init()
	{
		...
		for(int i=0;i<rowList.Count;i++)
		{
			...
			{
				TrumpAction pa = new TrumpAction ();
				pa.id = id;
